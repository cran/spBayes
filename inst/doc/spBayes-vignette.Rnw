...
\begin{figure}[h!]
  \begin{center}
    \subfigure[]{\label{SynObs}\includegraphics[width=7cm]{synObsa.pdf}}\\
    \subfigure[]{\label{SynObsSurf1}\includegraphics[width=7cm]{synObsb.pdf}}
    \subfigure[]{\label{SynObsSurf2}\includegraphics[width=7cm]{synObsc.pdf}} 
  \end{center}
...
\begin{figure}[h!]
  \begin{center}
    \subfigure[]{\label{SynPredWSurf}\includegraphics[width=14cm]{synPredWSurf.pdf}}\\
    \subfigure[]{\label{SynPredYSurf}\includegraphics[width=14cm]{synPredYSurf.pdf}} 
  \end{center}
...
\begin{figure}[h!]
  \begin{center}
    \subfigure[]{\label{RealObs}\includegraphics[width=7cm]{befObsa.pdf}}\\
    \subfigure[]{\label{RealObsSurf1}\includegraphics[width=7cm]{befObsb.pdf}}
    \subfigure[]{\label{RealObsSurf2}\includegraphics[width=7cm]{befObsc.pdf}} 
  \end{center}
...
\begin{figure}[htp]
  \begin{center}
    \subfigure[]{\label{RealPredWSurf}\includegraphics[width=14cm]{befPredWSurf.pdf}}\\
    \subfigure[]{\label{RealPredYSurf}\includegraphics[width=14cm]{befPredYSurf.pdf}} 
  \end{center}
