...
##bayes.lm.ref <- function(lm.obj, NITER) {
...
bayes.lm.ref <- function(lm.obj, n.samples, ...) {
...
normal.igamma.sampler <- function(n.samples, mu, V, a, b){
...
bayes.lm.conjugate <- function(formula, data = parent.frame(), n.samples, beta.prior.mean, beta.prior.precision,
...
##
##  posterior.samples <- normal.igamma.sampler(n.samples, posterior.mean, posterior.variance, nugget.posterior.shape, nugget.posterior.rate)
##
...
bayes.geostat.exact <- function (formula, data = parent.frame(), n.samples, beta.prior.mean, beta.prior.precision,
  ...
  posterior.samples <- as.matrix(normal.igamma.sampler(n.samples, posterior.mean, posterior.variance, sigma.sq.posterior.shape, sigma.sq.posterior.rate))
